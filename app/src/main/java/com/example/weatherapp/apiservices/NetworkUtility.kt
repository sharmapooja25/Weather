...
object NetworkUtility {
    ...
    class Builder(baseURL: String, mContext : Context) {
        ...
        private var connectionTimeout: Long = 1
        private var readTimeout: Long = 1
        private var writeTimeout: Long = 1
            ...
            builder.addInterceptor(object : Interceptor {
                ...
                override fun intercept(chain: Interceptor.Chain): Response {
                    ...
                    val requestBuilder = original.newBuilder()
                       // .header("Authorization", "Bearer " + Preference(context).getUserToken())
